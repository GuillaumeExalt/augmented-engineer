...
**Contexte**
La couche application expose la demande de modification de commande et applique le bon parcours selon l'etat de la commande: modification immediate si non acquittee, rejet si le nouveau cout depasse les soldes, ou creation d'une demande de changement si deja acquittee.
...
Scenario: 2 - Rejeter une modification qui depasse les soldes via API
...
Scenario: 3 - Creer une demande de changement pour une commande acquittee
...
**Notes**
- Le resultat doit distinguer clairement une modification appliquee, un rejet de validation et une demande de changement.
